...
import { Table, Button, Badge, Loader, Title, Card, Container, Group, Text, ActionIcon, Tooltip, Stack, Divider, Modal, Box, ScrollArea } from "@mantine/core";
...
export default function ReferralsPage() {
  ...
  useEffect(() => {
    ...
    fetchHouseholds();
  }, [fetchHouseholds]); // Only run once on mount
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-rose-25">
      <Container size="xl" className="py-4 sm:py-8 px-2 sm:px-4" pt={80}>
        {/* Enhanced Header with Statistics */}
        <Card shadow="sm" radius="xl" className="bg-white/70 backdrop-blur-sm border border-rose-100 mb-4 sm:mb-6">
          <Group justify="space-between" className="mb-4 flex-col lg:flex-row gap-4">
            ...
            <Group gap="sm" className="flex-wrap justify-center lg:justify-end">
              <Stack gap={4} align="center" className="min-w-[60px]">
                <Text size="xs" className="text-gray-500 font-medium">TOTAL</Text>
                <Group gap={6} align="center">
                  <FileText size={14} className="text-gray-700 hidden sm:block" />
              ...
              <Stack gap={4} align="center" className="min-w-[70px]">
              ...
              <Stack gap={4} align="center" className="min-w-[80px]">
                <Text size="xs" className="text-green-600 font-medium">APPROVED</Text>
                <Group gap={6} align="center">
                  <CheckCircle size={14} className="text-green-600 hidden sm:block" />
                  <Text size="lg" className="font-bold text-green-700">{approvedCount}</Text>
                </Group>
              </Stack>
              
              <Stack gap={4} align="center" className="min-w-[90px]">
        ...
        <Card shadow="md" radius="xl" className="bg-white/90 backdrop-blur-sm border border-rose-200 mb-6 sm:mb-8 hover:shadow-lg transition-all duration-200">
          <div className="mb-4">
            <Title order={4} className="text-gray-800 mb-2 text-lg sm:text-xl">Create New Referral</Title>
        ...
        <Card shadow="md" radius="xl" className="bg-white/90 backdrop-blur-sm border border-rose-200 hover:shadow-lg transition-all duration-200">
          {loading ? (
            ...
            <ScrollArea scrollbars="x" offsetScrollbars scrollbarSize={6}>
              <Box style={{ minWidth: '1200px', width: 'max-content' }}>
                <Table 
                  highlightOnHover 
                  verticalSpacing="lg"
                ...
                >
                  <Table.Thead className="bg-gradient-to-r from-rose-100 to-rose-50">
                    <Table.Tr>
                      <Table.Th className="text-gray-700 font-semibold min-w-[180px]">
                        <Group gap={6}>
                          <Users size={16} />
                          <span>Household</span>
                        </Group>
                      </Table.Th>
                      <Table.Th className="text-gray-700 font-semibold min-w-[150px]">Program</Table.Th>
                      <Table.Th className="text-gray-700 font-semibold min-w-[120px]">Barangay</Table.Th>
                      <Table.Th className="text-gray-700 font-semibold min-w-[160px]">
                        <Group gap={6}>
                          <User size={16} />
                          <span>Submitted By</span>
                        </Group>
                      </Table.Th>
                      <Table.Th className="text-gray-700 font-semibold min-w-[120px]">Status</Table.Th>
                      <Table.Th className="text-gray-700 font-semibold min-w-[200px]">Notes</Table.Th>
                      <Table.Th className="text-gray-700 font-semibold min-w-[140px]">
                        <Group gap={6}>
                          <Calendar size={16} />
                          <span>Date</span>
                        </Group>
                      </Table.Th>
                      <Table.Th className="text-gray-700 font-semibold min-w-[200px]">Actions</Table.Th>
                    </Table.Tr>
                  </Table.Thead>
                  <Table.Tbody>
                    {referrals.map(ref => (
                      ...
                      >
                        ...
                        <Table.Td>
                          ...
                          >
                            <Text 
                              className="text-gray-600 truncate max-w-[180px] cursor-help"
                              size="sm"
                            >
                              {ref.notes || 'No notes'}
                            </Text>
                        ...
                        <Table.Td>
                          <Group gap="xs" className="flex-nowrap">
                              ...
                              <>
                                <Tooltip label="Approve referral">
                                  <Button
                                    ...
                                    className="bg-green-500 hover:bg-green-600 text-white transition-all duration-200 hover:shadow-md whitespace-nowrap"
                                  >
                                    Approve
                                  </Button>
                                </Tooltip>
                                <Tooltip label="Mark as completed">
                                  <Button
                                    ...
                                    disabled={actionLoading[ref._id]}
                                    className="bg-blue-500 hover:bg-blue-600 text-white transition-all duration-200 hover:shadow-md whitespace-nowrap"
                                  >
                                    Complete
                                  </Button>
                                </Tooltip>
                            ...
                            {(role === "admin" || role === "ngo_staff") && ref.status !== "pending" && (
                              <Badge variant="light" color="gray" size="sm" className="whitespace-nowrap">
